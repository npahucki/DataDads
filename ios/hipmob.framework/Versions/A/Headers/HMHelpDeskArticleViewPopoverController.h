...
*/
- (id)initWithView:(id)view andAppID:(NSString *)app andArticle:(NSString *)articleId;
...
*/
- (id)initWithView:(id)view andAppID:(NSString *)app andArticle:(NSString *)articleId andUser:(NSString *)user andInfo:(NSDictionary *)userInfo;
...
*/
- (id)initWithView:(id)view andAppID:(NSString *)app andArticleURL:(NSString *)articleUrl;
...
* {email}, {context} and {pushtoken}.
*/
- (id)initWithView:(id)view andAppID:(NSString *)app andArticleURL:(NSString *)articleUrl andUser:(NSString *)user andInfo:(NSDictionary *)userInfo;
